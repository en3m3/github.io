...
if(bodyClasses.contains("apiTest")) {
    ...
    var locationID = "5607916";
} else if(bodyClasses.contains("fishHaven")) {
    var page = "FishHaven";
    var locationID = "5585010";
} else{
    var locationID = "5604473";
}
...
fetch(requestURL)
    ...
    var requestURL = `https://api.openweathermap.org/data/2.5/forecast?id=${locationID}&units=imperial&appid=01c123b90547d5719b9721540f7c306f`
    fetch(requestURL)
    .then(function (response) {
        return response.json();
    })
